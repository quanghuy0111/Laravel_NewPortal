...
<div class="form-group">
 ...
 <div class="form-group">
    <label for="exampleTextarea1">Address Vietnamese</label>
    <textarea class="form-control" name="address_vn" id="summernote1">
       {{ $websitesetting->address_vn }}
    </textarea>
                      </div>
  ...
  <div class="form-group">
    <label for="exampleInputEmail1"> Phone Vietnamese</label>
    <input type="text" class="form-control" name="phone_vn"  value="{{ $websitesetting->phone_vn }}">
     </div>
