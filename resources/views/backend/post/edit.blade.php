  ...
  @csrf
    ...
    <div class="form-group col-md-6">
     ...
     <div class="form-group col-md-6">
      ...
      <input type="text" class="form-control" id="exampleInputName1" name="title_vn" value="{{ $post->title_vn }}">
    </div>
...
<div class="row">
    ...
    <div class="form-group col-md-6">
     ...
     <div class="form-group col-md-6">
      ...
      <input type="text" class="form-control" id="exampleInputName1" name="tags_vn" value="{{ $post->tags_vn }}">
    </div>
