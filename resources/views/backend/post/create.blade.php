 ...
 <form class="forms-sample" action="{{ route('store.post') }}" method="post" enctype="multipart/form-data">
  @csrf
    ...
    <div class="form-group col-md-6">
     ...
     <div class="form-group col-md-6">
      <label for="exampleInputName1">Title Vietnamese</label>
      <input type="text" class="form-control" id="exampleInputName1" name="title_vn">
    </div>
...
<div class="row">
    ...
    <div class="form-group col-md-6">
     ...
     <div class="form-group col-md-6">
      <label for="exampleInputName1">Tags Vietnamese</label>
      <input type="text" class="form-control" id="exampleInputName1" name="tags_vn">
    </div>
...
<div class="form-group">
 ...
 <div class="form-group">
    ...
    <textarea class="form-control" name="details_vn" id="summernote1"></textarea>
                      </div>
