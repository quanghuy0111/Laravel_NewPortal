        ...
        <div class="container-fluid">
            <div class="row">
                    ...
                    <div class="row">
                        ...
                        @foreach ($firstsection as $row)
                            <div class="col-md-3 col-sm-3">
                                <div class="top-news">
                                    <a href="{{ URL::to('view/post/' . $row->id) }}"><img src="{{ asset($row->image) }}"
                                            alt="Notebook"></a>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            ...
                            <div class="add">
                                ...
                                @if ($horizontal == null)
                                @else
                                    <a href="{{ $horizontal->link }}" target="_blank"><img
                                            src=" {{ asset($horizontal->ads) }}" alt="" /></a>
                                @endif
                            ...
                            <div class="bg-one">
                                <div class="cetagory-title"><a href="#">
                                        ...
                                        <span>
                                            ...
                                            @else
                                                Thêm
                                                @endif <i class="fa fa-angle-double-right" aria-hidden="true"></i>
                                        </span>
                                    </a></div>
                                <div class="row">
                                    <div class="col-md-6 col-sm-6">
                                        <div class="top-news">
                                            <a href="#"><img src="{{ asset($secondcatpostbig->image) }}"
                                                    alt="Notebook"></a>
                                            <h4 class="heading-02"><a href="#">
                                                    @if (session()->get('lang') == 'english')
                                                        {{ $secondcatpostbig->title_en }}
                                                    @else
                                                        {{ $secondcatpostbig->title_vn }}
                                                    @endif
                                                </a>
                                            </h4>
                                        </div>
                ...
                <div class="col-md-3 col-sm-3">
                    ...
                    @if ($livetv->status == 1)
                        ...
                        <div class="photo">
                            <div class="embed-responsive embed-responsive-16by9 embed-responsive-item"
                                ...
                                {!! $livetv->embed_code !!}<iframe width="560" height="315"
                                    src="https://www.youtube.com/embed/5jS6zGo_7p0" frameborder="0"
                    ...
                    <div class="fb-page" data-href="https://www.facebook.com/TruongDaihocSaiGon.SGU" data-tabs=""
                        data-width="" data-height="" data-small-header="false" data-adapt-container-width="true"
                        data-hide-cover="false" data-show-facepile="false">
                        <blockquote cite="https://www.facebook.com/TruongDaihocSaiGon.SGU" class="fb-xfbml-parse-ignore"><a
                                href="https://www.facebook.com/TruongDaihocSaiGon.SGU">Trường Đại học Sài Gòn</a></blockquote>
                    </div>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-4 col-sm-5">
                    ...
                    @php
                        $videobig = DB::table('videos')
                            ->where('type', 1)
                            ->orderBy('id', 'desc')
                            ->first();
                        $videosamll = DB::table('videos')
                            ->where('type', 0)
                            ->orderBy('id', 'desc')
                            ->limit(4)
                            ->get();
                                ...
                                <div class="myVideos" style="width:100%">
                                    <div class="embed-responsive embed-responsive-16by9 embed-responsive-item">
                                        <iframe width="853" height="480"
                                            src="https://www.youtube.com/embed/{{ $videobig->embed_code }}"
                                            frameborder="0"
